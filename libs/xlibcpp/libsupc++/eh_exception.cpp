...
std::exception::~exception() _XLIBCXX_TXN_SAFE_DYN _XLIBCXX_USE_NOEXCEPT { }

std::bad_exception::~bad_exception() _XLIBCXX_TXN_SAFE_DYN
    _XLIBCXX_USE_NOEXCEPT
{ }
...
const char* 
std::exception::what() const _XLIBCXX_TXN_SAFE_DYN _XLIBCXX_USE_NOEXCEPT
{
...
const char* 
std::bad_exception::what() const _XLIBCXX_TXN_SAFE_DYN _XLIBCXX_USE_NOEXCEPT
{
