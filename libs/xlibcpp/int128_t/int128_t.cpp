...
namespace std
{
// INT128_MIN is equal to: -170141183460469231731687303715884105728;
const int128_t INT128_MIN(0x00000000, 0x00000000, 0x00000000, 0x80000000);

// INT128_MAX is equal to:  170141183460469231731687303715884105727;
const int128_t INT128_MAX(0xffffffff, 0xffffffff, 0xffffffff, 0x7fffffff);

// UINT128_MIN is equal to:  0;
const uint128_t UINT128_MIN(0x00000000, 0x00000000, 0x00000000, 0x00000000);

// UINT128_MAX is equal to:  340282366920938463463374607431768211455;
...
int128_t::int128_t(uint32_t nPart0, uint32_t nPart1, uint32_t nPart2, uint32_t nPart3)
	: int128_t_base(nPart0, nPart1, nPart2, nPart3) // OK for TARGET_X86_64
{
}


int128_t::int128_t(uint64_t nPart0, uint64_t nPart1)
	: int128_t_base(nPart0, nPart1) // OK for TARGET_X86_64
{
}


int128_t::int128_t(uint8_t value)
	: int128_t_base(value) // OK for TARGET_X86_64
{
}
...
void int128_t::Int128ToStr(char* pValue, char** ppEnd, int nBase, LeadingZeroes lz, Prefix prefix) const
{
	...
	else if(nBase == 10)
	{
		...
		if(*this == INT128_MIN)
		{
			// This code has a special pathway because negating INT128_MIN results
			// in INT128_MIN and thus the code below can't work.
...
{
	DoubleToUint128(value); // OK for TARGET_X86_64
}
