...
static inline dotfont_t *dotfont_find(dotfont_library_t *dotflib, char *name)
{
    dotfont_t *dotfont;
    int i;
...
static inline int dotfont_install(dotfont_library_t *dotflib,
...
static inline int dotfont_uninstall(dotfont_library_t *dotflib, char *name)
{
...
static inline int dotfont_set_default(dotfont_library_t *dotflib, char *name)
{
    dotfont_t *dotfont = dotfont_find(dotflib, name);
    if (!dotfont)
        return -1;
...
static inline dotfont_t *dotfont_get_current(dotfont_library_t *dotflib)
{
...
static inline int dotfont_exit(dotfont_library_t *dotflib)
{
    if (!dotflib)
        return -1;
    dotfont_t *dotfont;
