...
#define CON_SCREEN_BG_COLOR    XTK_BLACK
#define CON_SCREEN_FONT_COLOR  XTK_WHITE

#define CON_MOUSE_COLOR  XTK_BLUE
...
typedef struct {
    ...
    int codepage;       /* 代码页 */
    xtk_color_t background_color;  /* 背景颜色 */
    xtk_color_t font_color;        /* 字体颜色 */
    xtk_color_t mouse_color;  /* 鼠标颜色 */
/// 函数指针
    void (*outc) (char);
    void (*outs) (char *);
    void (*clear) ();
